...
public class CustomerDetailsBill extends javax.swing.JFrame {
    public static String idd; // Refactored: Keeping behavior for bill generation
    /**
    ...
    public CustomerDetailsBill() {
        ...
        loadTableData("SELECT * FROM customer WHERE status='check out'");
    }
    // Refactoring: Extract Method to remove Duplicate Code
    // Refactoring: Consolidate Duplicate Fragments
    private void loadTableData(String query) {
        ...
        try (Connection con = ConnectionProvider.getCon();
            ...
            // If query needs parameters (for search), we handle it here
            if (query.contains("outdate=?")) {
            ...
            // Refactoring: Proper error reporting replaces Dead Code
...
dispose();         // TODO add your handling code here:
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            idd = jTable1.getValueAt(selectedRow, 0).toString();
            new GenerateBill().setVisible(true);
        }
    }//GEN-LAST:event_jTable1MouseClicked

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // Refactoring: Reuse the extracted method
        loadTableData("SELECT * FROM customer WHERE status=? AND outdate=?");
